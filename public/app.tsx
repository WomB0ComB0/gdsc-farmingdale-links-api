  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', minHeight: '100vh' }}>
      ...
      <main
        ...
        style={{ flex: 1, paddingBottom: 'var(--spacing-lg)' }}
      >
        <section
          style={{
            display: 'flex',
        ...
        >
          ...
          >
            ...
            >
              ...
              is to provide a way for any GDSC chapter to access their event data. This API returns
              2 JSON objects:
            </p>
          ...
          >
            ...
            >
              ...
              >
                ...
                <span
                  style={{
                    transform: openAccordion === 'past' ? 'rotate(180deg)' : 'rotate(0)',
              ...
              <div className={`accordion-content ${openAccordion === 'past' ? 'open' : ''}`}>
                <div
                  ...
                  style={{ padding: 'var(--spacing-sm)', borderTop: 'var(--border-glass)' }}
                >
                  <ul
                  ...
                  >
                    ...
                    <li>
                      <strong>thumbnailLink:</strong> string
                    </li>
                    <li>
                      <strong>detailsLink:</strong> string
                    </li>
                  </ul>
                </div>
              </div>
            ...
            >
              ...
              >
                ...
                <span
                  style={{
                    transform: openAccordion === 'upcoming' ? 'rotate(180deg)' : 'rotate(0)',
                    transition: 'transform 0.3s',
                  }}
                >
                  ▼
